...
traffics=[
    ...
    car.Car(our_road.get_lane_center(0), 9600, 30, 45,"TRAFFIC",max_speed=2),
    car.Car(our_road.get_lane_center(2), 9600, 30, 45,"TRAFFIC",max_speed=2),
    car.Car(our_road.get_lane_center(1), 9400, 30, 45,"TRAFFIC",max_speed=2),
    car.Car(our_road.get_lane_center(0), 9400, 30, 45,"TRAFFIC",max_speed=2),
    car.Car(our_road.get_lane_center(0), 9200, 30, 45,"TRAFFIC",max_speed=2),
    car.Car(our_road.get_lane_center(2), 9200, 30, 45,"TRAFFIC",max_speed=2)
]
